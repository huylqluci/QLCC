...
import {HistoryOrderComponent} from "../../../admin/manage-house/edit-and-history/history-order/history-order.component";
...
export class SearchOrderComponent implements OnInit {
  displayedColumns: string[] = ['id', 'fullname', 'dateIn', 'dateOut', 'price', 'creatorName', 'houseName', 'status', 'action'];
  ...
  searchBooking() {
    this.bookingService
      .seachBooking(this.searchForm.get('phone').value, this.searchForm.get('id').value)
      .subscribe(
        (data) => {
